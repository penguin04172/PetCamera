...
bool R_PG_I2C_Set_C0(void)
{
	return R_IIC_Create(
		...
		PDL_IIC_NTALD_DISABLE | PDL_IIC_SALD_DISABLE | PDL_IIC_SLAVE_0_ENABLE_7 | PDL_IIC_SLAVE_1_DISABLE | PDL_IIC_SLAVE_2_DISABLE | PDL_IIC_SLAVE_GCA_DISABLE | PDL_IIC_DEVICE_ID_DISABLE | PDL_IIC_HOST_ADDRESS_DISABLE,
		0x0050,
		0,
		0,
		( 1 << 31 ) | ( 24 << 8 ) | 24,
...
* Include      : 
*
* Declaration  : bool R_PG_I2C_SlaveMonitor_C0(uint8_t * data, uint16_t count)
*
* Function Name: R_PG_I2C_SlaveMonitor_C0
*
* Description  : Slave bus monitor
*
* Arguments    : uint8_t * data : The start address of the received data.
*              : uint16_t count : The number of the data to be received.
*
* Return Value : true  : Setting was made correctly.
*              : false : Setting failed.
*
* Calling Functions : R_IIC_SlaveMonitor
*
* Details      : Please refer to the Reference Manual.
******************************************************************************/
bool R_PG_I2C_SlaveMonitor_C0(uint8_t * data, uint16_t count)
{
	if( data == 0 )
	{
		return false;
	...
	return R_IIC_SlaveMonitor(
		0,
		PDL_IIC_RX_DTC_TRIGGER_DISABLE | PDL_IIC_TX_DTC_TRIGGER_DISABLE,
		data,
		count,
		i2cSlFunc,
		15
...
* Include      : 
*
* Declaration  : bool R_PG_I2C_SlaveSend_C0(uint8_t * data, uint16_t count)
*
* Function Name: R_PG_I2C_SlaveSend_C0
*
* Description  : Slave data transmission
*
* Arguments    : uint8_t * data : The start address of the data to be transmitted.
*              : uint16_t count : The number of the data to be transmitted.
*
* Return Value : true  : Setting was made correctly.
*              : false : Setting failed.
*
* Calling Functions : R_IIC_SlaveSend
*
* Details      : Please refer to the Reference Manual.
******************************************************************************/
bool R_PG_I2C_SlaveSend_C0(uint8_t * data, uint16_t count)
{
	if( data == 0 )
	{
		return false;
...
* Include      : 
*
* Declaration  : bool R_PG_I2C_GetDetectedAddress_C0(bool * addr0, bool * addr1, bool * addr2, bool * general, bool * device, bool * host)
*
* Function Name: R_PG_I2C_GetDetectedAddress_C0
*
* Description  : Get the detected address
*
* Arguments    : bool * addr0 : The address of storage area for slave address 0 detection flag.
*              : bool * addr1 : The address of storage area for slave address 1 detection flag.
...
* Details      : Please refer to the Reference Manual.
******************************************************************************/
bool R_PG_I2C_GetDetectedAddress_C0(bool * addr0, bool * addr1, bool * addr2, bool * general, bool * device, bool * host)
{
	uint32_t data;
	bool res;
...
* Include      : 
*
* Declaration  : bool R_PG_I2C_GetTR_C0(bool * transmit)
*
* Function Name: R_PG_I2C_GetTR_C0
*
* Description  : Get the transmit/receive mode
*
* Arguments    : bool * transmit : The address of storage area for the transmit mode flag.
*
* Return Value : true  : Acquisition succeeded.
*              : false : Acquisition failed.
*
...
* Details      : Please refer to the Reference Manual.
******************************************************************************/
bool R_PG_I2C_GetTR_C0(bool * transmit)
{
	uint32_t data;
	bool res;
	...
	if( transmit ){ *transmit = (data >> 6) & 0x01; }
