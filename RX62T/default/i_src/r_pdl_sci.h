/*""FILE COMMENT""*******************************************************
* System Name	: Serial Interface API for RX62T
...
#define PDL_SCI_PIN_SCI2_A	0x01u
#define PDL_SCI_PIN_SCI2_B	0x02u
...
/* Data length */
#define PDL_SCI_8_BIT_LENGTH	0x00002000ul
#define PDL_SCI_7_BIT_LENGTH	0x00004000ul

/* Parity selection */
#define PDL_SCI_PARITY_NONE		0x00008000ul

/* Stop bit length */
#define PDL_SCI_STOP_1			0x00010000ul
#define PDL_SCI_STOP_2			0x00020000ul

#define PDL_SCI_8N1	(PDL_SCI_8_BIT_LENGTH | PDL_SCI_PARITY_NONE | PDL_SCI_STOP_1)

/* noise cancellation */
#define PDL_SCI_NC_ENABLE		0x00040000ul
#define PDL_SCI_NC_DISABLE		0x00080000ul
...
/* ----------------------------------------------- */
/* DTC trigger control */
#define PDL_SCI_DTC_TRIGGER_DISABLE	0x0001u
#define PDL_SCI_DTC_TRIGGER_ENABLE	0x0002u

/* ID cycle indication for Multi-processor mode */
#define PDL_SCI_MP_ID_CYCLE			0x0004u
