/*""FILE COMMENT""*******************************************************
* System Name	: Serial Peripheral Interface API for RX62Txx
...
#define PDL_SPI_PIN_A					0x00000080ul
#define PDL_SPI_PIN_B					0x00000100ul
#define PDL_SPI_PIN_C					0x00000200ul
#define PDL_SPI_PIN_RSPCK_ENABLE		0x00000400ul
#define PDL_SPI_PIN_RSPCK_DISABLE		0x00000800ul
#define PDL_SPI_PIN_MOSI_ENABLE			0x00001000ul
#define PDL_SPI_PIN_MOSI_DISABLE		0x00002000ul
#define PDL_SPI_PIN_MISO_ENABLE			0x00004000ul
#define PDL_SPI_PIN_MISO_DISABLE		0x00008000ul
#define PDL_SPI_PIN_SSL0_LOW			0x00010000ul
#define PDL_SPI_PIN_SSL0_HIGH			0x00020000ul
#define PDL_SPI_PIN_SSL0_DISABLE		0x00040000ul
#define PDL_SPI_PIN_SSL1_LOW			0x00080000ul
#define PDL_SPI_PIN_SSL1_HIGH			0x00100000ul
#define PDL_SPI_PIN_SSL1_DISABLE		0x00200000ul
#define PDL_SPI_PIN_SSL2_LOW			0x00400000ul
#define PDL_SPI_PIN_SSL2_HIGH			0x00800000ul
#define PDL_SPI_PIN_SSL2_DISABLE		0x01000000ul
#define PDL_SPI_PIN_SSL3_LOW			0x02000000ul
#define PDL_SPI_PIN_SSL3_HIGH			0x04000000ul
#define PDL_SPI_PIN_SSL3_DISABLE		0x08000000ul
#define PDL_SPI_PIN_MOSI_IDLE_LAST		0x10000000ul
#define PDL_SPI_PIN_MOSI_IDLE_LOW		0x20000000ul
#define PDL_SPI_PIN_MOSI_IDLE_HIGH		0x40000000ul
...
/* DTC trigger control */
#define PDL_SPI_DTC_TRIGGER_DISABLE		0x01u
#define PDL_SPI_DTC_TRIGGER_ENABLE		0x02u
