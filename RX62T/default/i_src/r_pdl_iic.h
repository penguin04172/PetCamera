...
/* Master DTC trigger control */
#define PDL_IIC_DTC_TRIGGER_DISABLE			0x0010u
#define PDL_IIC_DTC_TRIGGER_ENABLE			0x0040u

/* Slave DTC trigger control */
#define PDL_IIC_RX_DTC_TRIGGER_DISABLE		0x0080u
#define PDL_IIC_RX_DTC_TRIGGER_ENABLE		0x0200u
#define PDL_IIC_TX_DTC_TRIGGER_DISABLE		0x0400u
