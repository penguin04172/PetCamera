...
******************************************************************************
* File Name    : R_PG_Timer_MTU_U0_C4.c
* Version      : 1.00
* Device(s)    : 
* Tool-Chain   : 
* H/W Platform : 
...
******************************************************************************/
#include "R_PG_Timer_MTU_U0_C4.h"
...
* Include      : 
*
* Declaration  : bool R_PG_Timer_Set_MTU_U0_C4(void)
*
* Function Name: R_PG_Timer_Set_MTU_U0_C4
*
...
******************************************************************************/
bool R_PG_Timer_Set_MTU_U0_C4(void)
{
